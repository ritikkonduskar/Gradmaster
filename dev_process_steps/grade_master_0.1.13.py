...
# TODO: this should be better formatted    
    ...
    for id in id_list:
        ...
        data_dict[id]['overall_letter_grade'] = []
    ...
    for i in xrange(n_assignment_keys):        
        ...
        for key in assignment_keys_list[0:i+1]:
            if "HW" in key: n_hw +=1        
        for id in id_list:
        # distinguish different cases for grade projections
...
# TODO: instead of hardwiring, we may want to build more flexibility in here 
            ...
            data_dict[id]['overall_grade'].append(overall_grade)

                
    # test if this works
    for id in id_list:
        print str(id) + ' ' + str(data_dict[id]['overall_grade'])
